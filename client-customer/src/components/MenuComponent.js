...
class Menu extends Component {
  ...
  render() {
    ...
    const isSearchDisabled = !this.state.txtKeyword;
    return (
      <nav
        className={`bg-white border-gray-200 dark:bg-gray-900 sticky top-0 z-50`}
      >
          ...
          <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
            ...
            >
              <img
                src="/nike-logo.png"
                alt="Nike Logo"
                className="h-20 w-20 mr-4" // Adjust the height and width as needed
              />
